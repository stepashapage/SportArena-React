import "./EnterainmentSection.scss";
import img1 from "../../../img/img_ChildArena/2-main/section-3/Main/image 1.svg";

export default function EnterainmentSection() {
    return (
        <>
            <section class="section">
                <div class="section-container section3-container">
                    <div class="section3-container__enterainment">
